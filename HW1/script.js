...
const superLink2 = document.querySelector('#super_link');
console.log(superLink2);

/*2. Внутри всех элементов на странице, которые имеют класс "card-link", поменяйте текст внутри элемента на "ссылка".*/

const cardLinkArray = document.querySelectorAll('.card-link')
cardLinkArray.forEach(element => {
...
const cardLinkCardBodyArray = document.querySelectorAll('.card-body .card-link');
cardLinkCardBodyArray.forEach(element => {
    console.log(element);
});

/*4. Найти первый попавшийся элемент на странице у которого есть атрибут data - number со значением 50 и вывести его в консоль.*/

const element50 = document.querySelector('[data-number="50"]');
console.log(element50);
